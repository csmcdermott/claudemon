...
| **Last updated** | 2026-07-02 (v0.8.0: axis-label date/time hover chip on all charts + WKWebView locale-safe date formatting; follows v0.7.x hover improvements — query names, chart tooltip date titles, whole-row skill/MCP hover) |
